...
class __TwigTemplate_c89c4496a5d2c3a4f13a6953f6274cc549ec16de3a62dd7b075207621207b10d extends Twig_Template
{
      ...
      <td>
        ...
        echo "        >
          <a
            ...
            href=\"";
        // line 55
        echo twig_escape_filter($this->env, (((isset($context["premium_install_url"]) || array_key_exists("premium_install_url", $context))) ? (_twig_default_filter((isset($context["premium_install_url"]) ? $context["premium_install_url"] : null), "#")) : ("#")), "html", null, true);
        echo "\"
          >";
        // line 56
        ...
        echo "</span>
          <a
            ...
            href=\"";
        // line 74
        echo twig_escape_filter($this->env, (((isset($context["premium_activate_url"]) || array_key_exists("premium_activate_url", $context))) ? (_twig_default_filter((isset($context["premium_activate_url"]) ? $context["premium_activate_url"] : null), "#")) : ("#")), "html", null, true);
        echo "\"
          >";
        // line 75
...
";
    ...
    {
        return new Twig_Source("", "settings/premium.html", "/home3/njdecorg/public_html/wp-content/plugins/mailpoet/views/settings/premium.html");
    }
}
