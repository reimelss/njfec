...
class __TwigTemplate_bca878fbf0425f2ebaac31b9d248395678b73ada1b5e1a69f8a6951a03ecd1ce extends Twig_Template
{
      ...
      <td>
        <p>
          <label>
            <input
              ...
              ";
        // line 320
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscriber_email_notification", array()), "enabled", array())) {
            // line 321
            echo "                checked
              ";
        }
        ...
        echo "
          ...
          <input type=\"email\"
            ...
            value=\"";
        // line 340
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscriber_email_notification", array()), "address", array()), "html", null, true);
        echo "\"
...
";
    ...
    {
        return new Twig_Source("", "settings/basics.html", "/home3/njdecorg/public_html/wp-content/plugins/mailpoet/views/settings/basics.html");
    }
}
