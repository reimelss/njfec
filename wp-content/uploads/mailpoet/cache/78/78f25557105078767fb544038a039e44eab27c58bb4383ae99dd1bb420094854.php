...
class __TwigTemplate_dca3b3c363c4290ea02477f50e6bedccb15cfbbaa2e1b74c8a2b8e9107a80ea5 extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "/home3/njdecorg/public_html/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
