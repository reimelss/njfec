...
/* settings/mta.html */
class __TwigTemplate_64c47a3e65b7dbf047701250e30d188d0b4a11d6f4e7f0ba67aeee77004c4c3c extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        $context["mss_key_valid"] = ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "mta", array()), "mailpoet_api_key_state", array()), "state", array()) == "valid");
        // line 3
...
<ul class=\"mailpoet_sending_methods\">
  <li
    ...
    class=\"";
        ...
        echo " ";
        if ( !(isset($context["mss_key_valid"]) ? $context["mss_key_valid"] : null)) {
...
(isset($context["badgeClassName"]) ? $context["badgeClassName"] : null), "target" => "_blank"), "link");
        // line 91
        echo "
        </p>
      </div>
    ...
    <div class=\"mailpoet_status ";
      ...
      <div class=\"mailpoet_actions\">
        ...
        // line 109
        if (( !(isset($context["mss_key_valid"]) ? $context["mss_key_valid"] : null) || ($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "mta_group", array()) == "mailpoet"))) {
            echo " mailpoet_hidden ";
        }
        echo "\">
      ...
      <tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["interval"]) {
            ...
            echo "\"
                ";
            // line 289
            if (( !$this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "mta", array()), "frequency", array()), "interval", array()) && (            // line 290
      ...
      <tr class=\"mailpoet_smtp_field\" data-field=\"authentication\"
        ...
        <td>
          <label>
            ...
            ";
        // line 578
        if (( !$this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "mta", array()), "authentication", array()) || ($this->getAttribute($this->getAttribute(        // line 579
...
";
    ...
    {
        return new Twig_Source("", "settings/mta.html", "/home3/njdecorg/public_html/wp-content/plugins/mailpoet/views/settings/mta.html");
    }
}
