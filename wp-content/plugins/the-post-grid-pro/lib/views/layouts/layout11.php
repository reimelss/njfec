<?php
$html = $htmlDetail = $write_comments = $metaHtml = null;
...
$html .= "<div class='{$grid} {$class}' data-id='{$pID}'>";
    $html .= '<div class="rt-holder">';
		...
		if($imgSrc) {
			$html .= "<div class='rt-img-holder'><a data-id='{$pID}' class='{$anchorClass}' href='{$pLink}'><img class='rt-img-responsive' src='{$imgSrc}' alt='{$title}'></a></div>";
		}
