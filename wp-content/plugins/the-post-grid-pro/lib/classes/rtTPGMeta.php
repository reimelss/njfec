...
if(!class_exists('rtTPGMeta')):
    ...
    class rtTPGMeta
    {
        ...
        function rttpg_meta_settings_selection($post){
            ...
            $html = null;
            $html .='<div id="sc-tabs" class="rt-tab-container rt-setting-holder">';
                $html .='<ul class="rt-tab-nav">
                                <li><a href="#sc-post-post-source">'.__('Post Source',  'the-post-grid-pro').'</a></li>
                                <li><a href="#sc-post-layout-settings">'.__('Layout Settings',  'the-post-grid-pro').'</a></li>
                                <li><a href="#sc-field-selection">'.__('Field Selection', 'the-post-grid-pro').'</a></li>
                                <li><a href="#sc-style">'.__('Style', 'the-post-grid-pro').'</a></li>
                              </ul>';


                $html .='<div id="sc-post-post-source" class="rt-tab-content">';
