...
function mailpoet_premium_php_version_notice() {
  $notice = str_replace(
    ...
    __('MailPoet Premium requires PHP version 5.6 or newer (version 7 recommended). Please read our [link]instructions[/link] on how to resolve this issue.', 'mailpoet-premium')
  );
