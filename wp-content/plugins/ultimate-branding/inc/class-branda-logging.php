...
class UB_Logging {
	...
	*/
	public function register_post_type() {
		...
		register_post_type( $this->post_type, apply_filters( 'ub_logging_post_type_args', $args ) );
	}
	...
	*/
	...
	public function register_taxonomy() {
		register_taxonomy( 'ub_log_type', $this->post_type, array( 'public' => defined( 'WP_DEBUG' ) && WP_DEBUG ) );
