<div class="sui-dialog sui-dialog-lg" aria-hidden="true" tabindex="-1" id="branda-manage-all-modules">
	...
	<div class="sui-dialog-content" aria-labelledby="dialogTitle" aria-describedby="dialogDescription" role="dialog">
		<div class="sui-box branda-manage-all-modules-box" role="document">
			<div class="sui-box-header">
				<h1 class="sui-header-title"><?php esc_html_e( 'Manage All Modules', 'ub' ); ?></h1>
...
?>
			...
			<div class="sui-box-footer sui-box-footer-center">
				<button class="sui-button sui-button-ghost" data-a11y-dialog-hide="branda-manage-all-modules"><?php echo esc_html_x( 'Cancel', 'button', 'ub' ); ?></button>
