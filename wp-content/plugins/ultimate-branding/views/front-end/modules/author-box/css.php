 ...
 * Border with
 */
if ( 0 < $container_border_width ) { ?>
    border-width: <?php echo esc_attr( $container_border_width ); ?>px;
<?php } ?>
<?php
/**
 * Border Style
...
if ( 0 < $avatar_border_radius ) { ?>
    -webkit-border-radius: <?php echo esc_attr( $avatar_border_radius ); ?>px;
    -moz-border-radius: <?php echo esc_attr( $avatar_border_radius ); ?>px;
