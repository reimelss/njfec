...
?>
	...
	<div id="logooos_gene_short_leftSidebar">
		...
		<div class="logooos_sectionTitle">General Settings</div>
		...
		<div class="logooos_sectionTitle">Layout</div>
		...
		<div class="row logooos_slider_option logooos_grid_option">
		...
		<div class="row">
			<label for="logooos_itemsHeightPercentage">Item Height</label>
			<select id="logooos_itemsHeightPercentage" name="logooos_itemsHeightPercentage">
				<option value="1.50">150% of item width</option>
				<option value="1.45">145% of item width</option>
				<option value="1.40">140% of item width</option>
				<option value="1.35">135% of item width</option>
				<option value="1.30">130% of item width</option>
				<option value="1.25">125% of item width</option>
				<option value="1.20">120% of item width</option>
				<option value="1.15">115% of item width</option>
				<option value="1.10">110% of item width</option>
				<option value="1.05">105% of item width</option>
				<option value="1.00">100% of item width</option>
				<option value="0.95">95% of item width</option>
				<option value="0.90">90% of item width</option>
				<option value="0.85">85% of item width</option>
				<option value="0.80">80% of item width</option>
				<option value="0.75">75% of item width</option>
				<option value="0.70">70% of item width</option>
				<option value="0.65" selected >65% of item width</option>
				<option value="0.60">60% of item width</option>
				<option value="0.55">55% of item width</option>
				<option value="0.50">50% of item width</option>
				<option value="0.45">45% of item width</option>
				<option value="0.40">40% of item width</option>
				<option value="0.35">35% of item width</option>
				<option value="0.30">30% of item width</option>
				<option value="0.25">25% of item width</option>
				<option value="0.20">20% of item width</option>
				<option value="0.15">15% of item width</option>
				<option value="0.10">10% of item width</option>
			</select>
		</div>
		...
		<div class="logooos_sectionTitle">Hover Effect</div>
		...
		<div class="row logooos_hovereffect_option">
		...
		<div class="logooos_sectionTitle">Items Style</div>
		...
		<div class="row logooos_border_option">
		...
		<div class="logooos_list_option logooos_sectionTitle">List Dividers Style</div>
		
		<div class="row logooos_list_option">
		...
		<div class="row logooos_list_option logooos_list_border_option">
		...
		<div class="logooos_slider_option logooos_sectionTitle">Slider Settings</div>
		
		
		<div class="row logooos_slider_option">
		...
		<div class="row logooos_slider_option">
			<label for="logooos_transitionEffect">Transition Effect</label>
			<select id="logooos_transitionEffect" name="logooos_transitionEffect">
		...
		<div class="logooos_list_option logooos_sectionTitle">Font Style</div>
		...
		<div class="row logooos_list_option logooos_font_option">
		...
		<div class="logooos_list_option logooos_sectionTitle">More Link</div>
