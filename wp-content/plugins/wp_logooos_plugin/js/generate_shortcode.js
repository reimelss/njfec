...
$(window).load(function(){
	...
	logooos_itemsHeightPercentage = $('#logooos_itemsHeightPercentage');
	...
	logooos_transitionEffect = $('#logooos_transitionEffect');
	...
	logooos_slider_options = $('.logooos_slider_option');
	logooos_grid_options = $('.logooos_grid_option');
	logooos_list_options = $('.logooos_list_option');
	logooos_border_options = $('.logooos_border_option');
	logooos_hovereffect_options = $('.logooos_hovereffect_option');
	logooos_font_options = $('.logooos_font_option');
	logooos_list_border_options = $('.logooos_list_border_option');
	
	if(logooos_layout.val() == 'slider') {
		logooos_grid_options.slideUp();
		logooos_list_options.slideUp();
		logooos_slider_options.slideDown();
	}
	else if(logooos_layout.val() == 'grid') {
		logooos_slider_options.slideUp();
		logooos_list_options.slideUp();
		logooos_grid_options.slideDown();
	}
	else if(logooos_layout.val() == 'list') {
		logooos_slider_options.slideUp();
		logooos_grid_options.slideUp();
		logooos_list_options.slideDown();
	}
		
	if(logooos_border.val() == 'disabled') {
		logooos_border_options.slideUp();
	}
	
	if(logooos_font_style.val() == 'default') {
		logooos_font_options.slideUp();
	}
	
	if(logooos_list_border.val() == 'disabled') {
		logooos_list_border_options.slideUp();
	}
	
	if(logooos_hovereffect.val() == '' || logooos_hovereffect.val() == 'effect4') {
		logooos_hovereffect_options.slideUp();
	}
	...
	logooos_layout.change(function(){
		...
		if(logooos_layout.val() == 'slider') {
			...
			if(logooos_font_style.val() == 'custom') {
				logooos_font_options.slideDown();
			}
			...
			if(logooos_list_border.val() == 'enabled') {
				logooos_list_border_options.slideDown();
			}
	...
	logooos_border.change(function(){
		...
		if(logooos_border.val() == 'enabled') {
			logooos_border_options.slideDown();
		}
	...
	logooos_hovereffect.change(function(){
		...
		if(logooos_hovereffect.val() == '' || logooos_hovereffect.val() == 'effect4') {
			...
			logooos_hovereffect_options.slideDown();
		}
...
function logooos_generate_shortcode() {
	...
	postarray['itemsheightpercentage'] = logooos_itemsHeightPercentage.val();
	shortcode+='itemsheightpercentage="'+ logooos_itemsHeightPercentage.val() +'" ';
	...
	if( logooos_layout.val()=='slider' ) {
		...
		postarray['transitioneffect'] = logooos_transitionEffect.val();
		shortcode+='transitioneffect="'+logooos_transitionEffect.val()+'" ';
