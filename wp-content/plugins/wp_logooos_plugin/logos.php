<?php
	...
	*/
	...
	function logooos_theme_enqueue() {
		...
		wp_register_script( 'logooos_ba_throttle_debounce', plugins_url('js/helper-plugins/jquery.ba-throttle-debounce.min.js', __FILE__) );
		wp_enqueue_script( 'logooos_ba_throttle_debounce' );
		
		wp_register_script( 'logooos_mousewheel', plugins_url('js/helper-plugins/jquery.mousewheel.min.js', __FILE__) );
		wp_enqueue_script( 'logooos_mousewheel' );
		
		wp_register_script( 'logooos_touchSwipe', plugins_url('js/helper-plugins/jquery.touchSwipe.min.js', __FILE__) );
		wp_enqueue_script( 'logooos_touchSwipe' );
		
		wp_register_script( 'logooos_transit', plugins_url('js/helper-plugins/jquery.transit.min.js', __FILE__) );
		wp_enqueue_script( 'logooos_transit' );
